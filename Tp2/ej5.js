...
const filtradosPaquetes = paquetesDatos.filter(p => p.tamaño > 1000);
const ordenadosPaquetes = filtradosPaquetes.sort((a, b) => b.prioridad - a.prioridad);

document.getElementById("ej5").textContent =
  "Paquetes filtrados (tamaño > 1000) y ordenados por prioridad:\n\n" +
  JSON.stringify(ordenadosPaquetes, null, 2);
